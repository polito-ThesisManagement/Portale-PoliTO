    ...
    <>
      ...
      <Container style={{ marginLeft: "0px", maxWidth: "1416px" }}>
        <Row>
          ...
          <BaseCard
            icon={
              <HiMiniClipboardDocumentCheck size="42" className="card-icon" />
            }
          ...
          <BaseCard
            ...
            description={
              "Iscrizione alle collaborazioni studentesche offerte dal Politecnico."
            }
          ...
          <BaseCard
            ...
            description={
              "Visualizzazione e adesione ai team studenteschi del Politecnico."
            }
          ...
          <BaseCard
            ...
            description={
              "Visualizzazione e adesione alle associazioni del Politecnico."
            }
