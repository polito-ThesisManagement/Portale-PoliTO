...
describe('Thesis proposals overview page', () => {
  ...
  it("should filter proposals by topic or description (string that doesn't exist)", () => {
    ...
    cy.get('.list-section .thesis-article').should('have.length', 0);
  });
  ...
  it('should filter proposals by topic or description (string that exists)', () => {
    ...
    // Main test logic
    cy.get('.list-section .thesis-article').each(article => {
  ...
  it('should apply multiple filters and reset them', () => {
    ...
    cy.get(
      '#root > div > div.main-space.reduced.col > div > div.proposals-container > main > div > div:nth-child(4) > button',
    ).click();
  ...
  it('should sort proposals by topic', () => {
    ...
    cy.get('.list-section .thesis-article').should('have.length.greaterThan', 0);
    cy.get('.list-section .thesis-article .thesis-topic').then($topics => {
  ...
  it('should sort proposals by description', () => {
    ...
    cy.get('.list-section .thesis-article').should('have.length.greaterThan', 0);
    cy.get('.list-section .thesis-article .thesis-description').then($descriptions => {
  ...
  it('should sort proposals by creation date', () => {
    ...
    cy.get('.list-section .thesis-article .thesis-dates').then($dates => {
  ...
  it('should sort proposals by expiration date', () => {
    ...
    cy.get('.list-section .thesis-article .thesis-footer-lower .thesis-tag').then($dates => {
  ...
  it('should change the number of proposals per page', () => {
    ...
    cy.get('.list-section .thesis-article').should('have.length', 5);
    ...
    cy.get('.list-section .thesis-article').should('have.length', 10);
    ...
    cy.get('.list-section .thesis-article').should('have.length', 20);
    ...
    cy.get('.list-section .thesis-article').should('have.length', 50);
  });
});
